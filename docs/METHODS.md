...
| --- | --- | --- |
| `addStickerToSet` | `addStickerToSet(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#addstickertoset) |
| `answerCallbackQuery` | `answerCallbackQuery(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#answercallbackquery) |
| `answerGuestQuery` | `answerGuestQuery(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#answerguestquery) |
| `answerInlineQuery` | `answerInlineQuery(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#answerinlinequery) |
| `answerPreCheckoutQuery` | `answerPreCheckoutQuery(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#answerprecheckoutquery) |
| `answerShippingQuery` | `answerShippingQuery(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#answershippingquery) |
| `answerWebAppQuery` | `answerWebAppQuery(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#answerwebappquery) |
| `approveChatJoinRequest` | `approveChatJoinRequest(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#approvechatjoinrequest) |
| `approveSuggestedPost` | `approveSuggestedPost(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#approvesuggestedpost) |
| `banChatMember` | `banChatMember(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#banchatmember) |
| `banChatSenderChat` | `banChatSenderChat(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#banchatsenderchat) |
| `close` | `close(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#close) |
| `closeForumTopic` | `closeForumTopic(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#closeforumtopic) |
| `closeGeneralForumTopic` | `closeGeneralForumTopic(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#closegeneralforumtopic) |
| `convertGiftToStars` | `convertGiftToStars(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#convertgifttostars) |
| `copyMessage` | `copyMessage(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#copymessage) |
| `copyMessages` | `copyMessages(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#copymessages) |
| `createChatInviteLink` | `createChatInviteLink(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#createchatinvitelink) |
| `createChatSubscriptionInviteLink` | `createChatSubscriptionInviteLink(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#createchatsubscriptioninvitelink) |
| `createForumTopic` | `createForumTopic(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#createforumtopic) |
| `createInvoiceLink` | `createInvoiceLink(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#createinvoicelink) |
| `createNewStickerSet` | `createNewStickerSet(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#createnewstickerset) |
| `declineChatJoinRequest` | `declineChatJoinRequest(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#declinechatjoinrequest) |
| `declineSuggestedPost` | `declineSuggestedPost(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#declinesuggestedpost) |
| `deleteAllMessageReactions` | `deleteAllMessageReactions(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#deleteallmessagereactions) |
| `deleteBusinessMessages` | `deleteBusinessMessages(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#deletebusinessmessages) |
| `deleteChatPhoto` | `deleteChatPhoto(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#deletechatphoto) |
| `deleteChatStickerSet` | `deleteChatStickerSet(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#deletechatstickerset) |
| `deleteForumTopic` | `deleteForumTopic(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#deleteforumtopic) |
| `deleteMessage` | `deleteMessage(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#deletemessage) |
| `deleteMessageReaction` | `deleteMessageReaction(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#deletemessagereaction) |
| `deleteMessages` | `deleteMessages(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#deletemessages) |
| `deleteMyCommands` | `deleteMyCommands(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#deletemycommands) |
| `deleteStickerFromSet` | `deleteStickerFromSet(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#deletestickerfromset) |
| `deleteStickerSet` | `deleteStickerSet(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#deletestickerset) |
| `deleteStory` | `deleteStory(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#deletestory) |
| `deleteWebhook` | `deleteWebhook(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#deletewebhook) |
| `editChatInviteLink` | `editChatInviteLink(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#editchatinvitelink) |
| `editChatSubscriptionInviteLink` | `editChatSubscriptionInviteLink(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#editchatsubscriptioninvitelink) |
| `editForumTopic` | `editForumTopic(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#editforumtopic) |
| `editGeneralForumTopic` | `editGeneralForumTopic(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#editgeneralforumtopic) |
| `editMessageCaption` | `editMessageCaption(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#editmessagecaption) |
| `editMessageChecklist` | `editMessageChecklist(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#editmessagechecklist) |
| `editMessageLiveLocation` | `editMessageLiveLocation(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#editmessagelivelocation) |
| `editMessageMedia` | `editMessageMedia(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#editmessagemedia) |
| `editMessageReplyMarkup` | `editMessageReplyMarkup(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#editmessagereplymarkup) |
| `editMessageText` | `editMessageText(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#editmessagetext) |
| `editStory` | `editStory(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#editstory) |
| `editUserStarSubscription` | `editUserStarSubscription(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#edituserstarsubscription) |
| `exportChatInviteLink` | `exportChatInviteLink(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#exportchatinvitelink) |
| `forwardMessage` | `forwardMessage(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#forwardmessage) |
| `forwardMessages` | `forwardMessages(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#forwardmessages) |
| `getAvailableGifts` | `getAvailableGifts(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#getavailablegifts) |
| `getBusinessAccountGifts` | `getBusinessAccountGifts(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#getbusinessaccountgifts) |
| `getBusinessAccountStarBalance` | `getBusinessAccountStarBalance(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#getbusinessaccountstarbalance) |
| `getBusinessConnection` | `getBusinessConnection(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#getbusinessconnection) |
| `getChat` | `getChat(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#getchat) |
| `getChatAdministrators` | `getChatAdministrators(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#getchatadministrators) |
| `getChatGifts` | `getChatGifts(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#getchatgifts) |
| `getChatMember` | `getChatMember(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#getchatmember) |
| `getChatMemberCount` | `getChatMemberCount(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#getchatmembercount) |
| `getChatMenuButton` | `getChatMenuButton(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#getchatmenubutton) |
| `getCustomEmojiStickers` | `getCustomEmojiStickers(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#getcustomemojistickers) |
| `getFile` | `getFile(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#getfile) |
| `getForumTopicIconStickers` | `getForumTopicIconStickers(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#getforumtopiciconstickers) |
| `getGameHighScores` | `getGameHighScores(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#getgamehighscores) |
| `getManagedBotAccessSettings` | `getManagedBotAccessSettings(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#getmanagedbotaccesssettings) |
| `getManagedBotToken` | `getManagedBotToken(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#getmanagedbottoken) |
| `getMe` | `getMe(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#getme) |
| `getMyCommands` | `getMyCommands(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#getmycommands) |
| `getMyDefaultAdministratorRights` | `getMyDefaultAdministratorRights(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#getmydefaultadministratorrights) |
| `getMyDescription` | `getMyDescription(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#getmydescription) |
| `getMyName` | `getMyName(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#getmyname) |
| `getMyShortDescription` | `getMyShortDescription(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#getmyshortdescription) |
| `getMyStarBalance` | `getMyStarBalance(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#getmystarbalance) |
| `getStarTransactions` | `getStarTransactions(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#getstartransactions) |
| `getStickerSet` | `getStickerSet(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#getstickerset) |
| `getUpdates` | `getUpdates(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#getupdates) |
| `getUserChatBoosts` | `getUserChatBoosts(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#getuserchatboosts) |
| `getUserGifts` | `getUserGifts(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#getusergifts) |
| `getUserPersonalChatMessages` | `getUserPersonalChatMessages(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#getuserpersonalchatmessages) |
| `getUserProfileAudios` | `getUserProfileAudios(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#getuserprofileaudios) |
| `getUserProfilePhotos` | `getUserProfilePhotos(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#getuserprofilephotos) |
| `getWebhookInfo` | `getWebhookInfo(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#getwebhookinfo) |
| `giftPremiumSubscription` | `giftPremiumSubscription(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#giftpremiumsubscription) |
| `hideGeneralForumTopic` | `hideGeneralForumTopic(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#hidegeneralforumtopic) |
| `leaveChat` | `leaveChat(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#leavechat) |
| `logOut` | `logOut(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#logout) |
| `pinChatMessage` | `pinChatMessage(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#pinchatmessage) |
| `postStory` | `postStory(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#poststory) |
| `promoteChatMember` | `promoteChatMember(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#promotechatmember) |
| `readBusinessMessage` | `readBusinessMessage(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#readbusinessmessage) |
| `refundStarPayment` | `refundStarPayment(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#refundstarpayment) |
| `removeBusinessAccountProfilePhoto` | `removeBusinessAccountProfilePhoto(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#removebusinessaccountprofilephoto) |
| `removeChatVerification` | `removeChatVerification(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#removechatverification) |
| `removeMyProfilePhoto` | `removeMyProfilePhoto(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#removemyprofilephoto) |
| `removeUserVerification` | `removeUserVerification(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#removeuserverification) |
| `reopenForumTopic` | `reopenForumTopic(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#reopenforumtopic) |
| `reopenGeneralForumTopic` | `reopenGeneralForumTopic(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#reopengeneralforumtopic) |
| `replaceManagedBotToken` | `replaceManagedBotToken(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#replacemanagedbottoken) |
| `replaceStickerInSet` | `replaceStickerInSet(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#replacestickerinset) |
| `repostStory` | `repostStory(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#repoststory) |
| `restrictChatMember` | `restrictChatMember(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#restrictchatmember) |
| `revokeChatInviteLink` | `revokeChatInviteLink(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#revokechatinvitelink) |
| `savePreparedInlineMessage` | `savePreparedInlineMessage(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#savepreparedinlinemessage) |
| `savePreparedKeyboardButton` | `savePreparedKeyboardButton(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#savepreparedkeyboardbutton) |
| `sendAnimation` | `sendAnimation(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#sendanimation) |
| `sendAudio` | `sendAudio(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#sendaudio) |
| `sendChatAction` | `sendChatAction(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#sendchataction) |
| `sendChecklist` | `sendChecklist(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#sendchecklist) |
| `sendContact` | `sendContact(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#sendcontact) |
| `sendDice` | `sendDice(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#senddice) |
| `sendDocument` | `sendDocument(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#senddocument) |
| `sendGame` | `sendGame(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#sendgame) |
| `sendGift` | `sendGift(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#sendgift) |
| `sendInvoice` | `sendInvoice(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#sendinvoice) |
| `sendLivePhoto` | `sendLivePhoto(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#sendlivephoto) |
| `sendLocation` | `sendLocation(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#sendlocation) |
| `sendMediaGroup` | `sendMediaGroup(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#sendmediagroup) |
| `sendMessage` | `sendMessage(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#sendmessage) |
| `sendMessageDraft` | `sendMessageDraft(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#sendmessagedraft) |
| `sendPaidMedia` | `sendPaidMedia(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#sendpaidmedia) |
| `sendPhoto` | `sendPhoto(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#sendphoto) |
| `sendPoll` | `sendPoll(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#sendpoll) |
| `sendSticker` | `sendSticker(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#sendsticker) |
| `sendVenue` | `sendVenue(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#sendvenue) |
| `sendVideo` | `sendVideo(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#sendvideo) |
| `sendVideoNote` | `sendVideoNote(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#sendvideonote) |
| `sendVoice` | `sendVoice(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#sendvoice) |
| `setBusinessAccountBio` | `setBusinessAccountBio(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#setbusinessaccountbio) |
| `setBusinessAccountGiftSettings` | `setBusinessAccountGiftSettings(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#setbusinessaccountgiftsettings) |
| `setBusinessAccountName` | `setBusinessAccountName(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#setbusinessaccountname) |
| `setBusinessAccountProfilePhoto` | `setBusinessAccountProfilePhoto(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#setbusinessaccountprofilephoto) |
| `setBusinessAccountUsername` | `setBusinessAccountUsername(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#setbusinessaccountusername) |
| `setChatAdministratorCustomTitle` | `setChatAdministratorCustomTitle(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#setchatadministratorcustomtitle) |
| `setChatDescription` | `setChatDescription(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#setchatdescription) |
| `setChatMemberTag` | `setChatMemberTag(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#setchatmembertag) |
| `setChatMenuButton` | `setChatMenuButton(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#setchatmenubutton) |
| `setChatPermissions` | `setChatPermissions(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#setchatpermissions) |
| `setChatPhoto` | `setChatPhoto(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#setchatphoto) |
| `setChatStickerSet` | `setChatStickerSet(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#setchatstickerset) |
| `setChatTitle` | `setChatTitle(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#setchattitle) |
| `setCustomEmojiStickerSetThumbnail` | `setCustomEmojiStickerSetThumbnail(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#setcustomemojistickersetthumbnail) |
| `setGameScore` | `setGameScore(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#setgamescore) |
| `setManagedBotAccessSettings` | `setManagedBotAccessSettings(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#setmanagedbotaccesssettings) |
| `setMessageReaction` | `setMessageReaction(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#setmessagereaction) |
| `setMyCommands` | `setMyCommands(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#setmycommands) |
| `setMyDefaultAdministratorRights` | `setMyDefaultAdministratorRights(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#setmydefaultadministratorrights) |
| `setMyDescription` | `setMyDescription(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#setmydescription) |
| `setMyName` | `setMyName(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#setmyname) |
| `setMyProfilePhoto` | `setMyProfilePhoto(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#setmyprofilephoto) |
| `setMyShortDescription` | `setMyShortDescription(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#setmyshortdescription) |
| `setPassportDataErrors` | `setPassportDataErrors(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#setpassportdataerrors) |
| `setStickerEmojiList` | `setStickerEmojiList(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#setstickeremojilist) |
| `setStickerKeywords` | `setStickerKeywords(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#setstickerkeywords) |
| `setStickerMaskPosition` | `setStickerMaskPosition(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#setstickermaskposition) |
| `setStickerPositionInSet` | `setStickerPositionInSet(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#setstickerpositioninset) |
| `setStickerSetThumbnail` | `setStickerSetThumbnail(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#setstickersetthumbnail) |
| `setStickerSetTitle` | `setStickerSetTitle(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#setstickersettitle) |
| `setUserEmojiStatus` | `setUserEmojiStatus(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#setuseremojistatus) |
| `setWebhook` | `setWebhook(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#setwebhook) |
| `stopMessageLiveLocation` | `stopMessageLiveLocation(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#stopmessagelivelocation) |
| `stopPoll` | `stopPoll(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#stoppoll) |
| `transferBusinessAccountStars` | `transferBusinessAccountStars(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#transferbusinessaccountstars) |
| `transferGift` | `transferGift(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#transfergift) |
| `unbanChatMember` | `unbanChatMember(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#unbanchatmember) |
| `unbanChatSenderChat` | `unbanChatSenderChat(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#unbanchatsenderchat) |
| `unhideGeneralForumTopic` | `unhideGeneralForumTopic(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#unhidegeneralforumtopic) |
| `unpinAllChatMessages` | `unpinAllChatMessages(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#unpinallchatmessages) |
| `unpinAllForumTopicMessages` | `unpinAllForumTopicMessages(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#unpinallforumtopicmessages) |
| `unpinAllGeneralForumTopicMessages` | `unpinAllGeneralForumTopicMessages(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#unpinallgeneralforumtopicmessages) |
| `unpinChatMessage` | `unpinChatMessage(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#unpinchatmessage) |
| `upgradeGift` | `upgradeGift(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#upgradegift) |
| `uploadStickerFile` | `uploadStickerFile(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#uploadstickerfile) |
| `verifyChat` | `verifyChat(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#verifychat) |
| `verifyUser` | `verifyUser(array\|TelegramBotRequestData $parameters = [])` | [Telegram docs](https://core.telegram.org/bots/api#verifyuser) |
