...
/**
 * Generated typed request builder for Telegram Bot API method `sendContact`.
 */
final readonly class SendContactRequestData extends TelegramBotApiRequestData
{
    public const string METHOD = 'sendContact';
