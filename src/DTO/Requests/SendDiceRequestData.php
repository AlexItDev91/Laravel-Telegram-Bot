...
/**
 * Generated typed request builder for Telegram Bot API method `sendDice`.
 */
final readonly class SendDiceRequestData extends TelegramBotApiRequestData
{
    public const METHOD = 'sendDice';
