...
/**
 * Generated typed request builder for Telegram Bot API method `sendPhoto`.
 */
final readonly class SendPhotoRequestData extends TelegramBotApiRequestData
{
    public const string METHOD = 'sendPhoto';
