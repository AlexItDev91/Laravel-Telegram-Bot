...
/**
 * Generated typed request builder for Telegram Bot API method `sendRichMessage`.
 */
final readonly class SendRichMessageRequestData extends TelegramBotApiRequestData
{
    public const string METHOD = 'sendRichMessage';
